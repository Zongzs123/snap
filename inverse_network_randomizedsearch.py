...
def inverse_network(units_layer1=128, units_layer2=128, optimizer='sgd'):
...
param_dist = {
    'units_layer1': [64, 100, 128, 150, 200, 256, 300, 400],
    'units_layer2': [64, 100, 128, 150, 200, 256, 300, 400],
...
random_search = RandomizedSearchCV(inverse_model, param_distributions=param_dist, n_iter=25, cv=5, scoring=scorer, verbose=2)
...
train_result = best_inverse_model.fit(inputs_train, targets_train, epochs=200, batch_size=64, callbacks=[lr_scheduler], verbose=2, validation_split=0.2)
...
array_type_validation_file = 'l2-array-type-validation-1128.csv'
